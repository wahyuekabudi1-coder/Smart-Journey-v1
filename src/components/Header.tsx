...
import { Menu, X, ChevronDown, Calendar, Globe, Plane, Car, Route, Star, Compass, Handshake, Share2 } from 'lucide-react';
            ...
            >
              <button
                ...
                className={`flex items-center space-x-1 px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 ${
                  ['tours', 'airport', 'taxi', 'car-rental'].includes(activePage)
                    ? 'text-amber-600 bg-amber-500/10 font-semibold'
                    : 'text-neutral-600 hover:text-neutral-900 hover:bg-neutral-100'
                }`}
              >
